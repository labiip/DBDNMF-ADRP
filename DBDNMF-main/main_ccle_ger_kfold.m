...
%     Y_tmp = Y_tmp - mean_Y_tmp;
    ...
    subplot(2,2,3);scatter(Y_0(Known_index),Y_recover1(Known_index),'.');
    %corr(Y_0(Known_index),Y_recover1(Known_index))
    %subplot(2,2,4);plot(1:length(obj_rec),obj_rec);
    %scatter(Y_0(Known_index),Y_recover2(Known_index),'.');
    %corr(Y_0(Known_index),Y_recover2(Known_index))
